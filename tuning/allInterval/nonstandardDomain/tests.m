...
testClose[optimizeGeneratorTuningMap, machine, {"tuningSchemeSystematicName" -> "nonprime-based minimax-E-copfr-S"(*,"logging" -> True*)}, "⟨1196.398 212.537]"];
...
testClose[optimizeGeneratorTuningMap, machine, {"tuningSchemeSystematicName" -> "nonprime-based minimax-E-sopfr-S"(*,"logging" -> True*)}, "⟨1197.766 215.083]"];
